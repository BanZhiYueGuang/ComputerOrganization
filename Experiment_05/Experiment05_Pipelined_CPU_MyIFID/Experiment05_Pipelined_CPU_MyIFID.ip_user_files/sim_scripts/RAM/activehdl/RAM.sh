...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxData/ComputerOrganization/Experiment_05/Experiment05_Pipelined_CPU_MyIFID/Experiment05_Pipelined_CPU_MyIFID.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
