...
#
# Script generated by Vivado on Tue Dec 30 15:19:49 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxData/ComputerOrganization/Experiment_05/Experiment05_Stall/Experiment05_Stall.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
