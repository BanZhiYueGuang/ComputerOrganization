...
HD_PWD='D:/XilinxData/ComputerOrganization/Experiment_05/Experiment05_Pipeline_CPU_MyEXMemWB/Experiment05_Pipeline_CPU_MyEXMemWB.runs/Seg7_Dev_0_synth_1'
cd "$HD_PWD"
