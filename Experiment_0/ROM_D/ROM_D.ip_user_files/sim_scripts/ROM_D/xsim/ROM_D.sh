...
#
# Script generated by Vivado on Tue Sep 23 16:49:22 +0800 2025
...
# script info
echo -e "ROM_D.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_D xil_defaultlib.ROM_D xil_defaultlib.glbl -log elaborate.log
}
