...
HD_PWD='D:/XilinxData/ComputerOrganization/Experiment_0/Exp00-muxctrl/Exp01-muxctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Expr01_muxctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Expr01_muxctrl.tcl
