...
HD_PWD='D:/XilinxData/ComputerOrganization/Experiment_0/Exp00-muxctrl/Exp01-muxctrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Expr01_muxctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Expr01_muxctrl.tcl -notrace
