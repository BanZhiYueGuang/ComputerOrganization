...
#
# Script generated by Vivado on Thu Oct 09 17:46:15 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxData/ComputerOrganization/Experiment_02/Expr02_IP2SOC/Expr02_IP2SOC.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
