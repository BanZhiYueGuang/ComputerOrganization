...
HD_PWD='D:/XilinxData/ComputerOrganization/Experiment_03/Experiment03_Div32/Experiment03_Div32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Div32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Div32.tcl
