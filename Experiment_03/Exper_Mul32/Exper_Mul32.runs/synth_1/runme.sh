...
HD_PWD='D:/XilinxData/ComputerOrganization/Experiment_03/Exper_Mul32/Exper_Mul32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mul32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mul32.tcl
