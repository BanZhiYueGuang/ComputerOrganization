...
#
# Script generated by Vivado on Tue Sep 23 16:54:33 +0800 2025
...
# script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_B xil_defaultlib.RAM_B xil_defaultlib.glbl -log elaborate.log
}
