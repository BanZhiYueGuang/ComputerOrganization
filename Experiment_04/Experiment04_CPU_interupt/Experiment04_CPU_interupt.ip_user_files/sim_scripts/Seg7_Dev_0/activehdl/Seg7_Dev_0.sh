...
#
# Script generated by Vivado on Thu Nov 27 15:56:03 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxData/ComputerOrganization/Experiment_04/Experiment04_CPU_interupt/Experiment04_CPU_interupt.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
