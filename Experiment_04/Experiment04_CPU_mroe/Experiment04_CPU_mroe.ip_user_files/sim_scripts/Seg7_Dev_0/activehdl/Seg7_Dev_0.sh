...
#
# Script generated by Vivado on Thu Nov 20 16:59:35 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxData/ComputerOrganization/Experiment_04/Experiment04_CPU_mroe/Experiment04_CPU_mroe.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
